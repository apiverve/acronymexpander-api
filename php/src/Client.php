...
namespace APIVerve\Acronymexpander;
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/acronymexpander?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/acronymexpander';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\AcronymexpanderClient] {$message}\n";
        }
    }
}
