...
```gradle
dependencies {
    implementation 'com.github.apiverve:acronymexpander-api:1.1.14'
}
```
...
```java
import com.apiverve.acronymexpander.AcronymExpanderAPIClient;
import com.apiverve.acronymexpander.APIResponse;
import com.apiverve.acronymexpander.APIException;

// Initialize the client
AcronymExpanderAPIClient client = new AcronymExpanderAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("acronym", "API");
    parameters.put("context", "General");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/acronymexpander](https://docs.apiverve.com/ref/acronymexpander)
...
- **Issues:** [GitHub Issues](https://github.com/apiverve/acronymexpander-api/issues)
