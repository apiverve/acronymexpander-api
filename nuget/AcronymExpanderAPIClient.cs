...
namespace APIVerve.API.AcronymExpander
{
    ...
    /// <summary>
    /// Client for the AcronymExpander API
    /// </summary>
    public class AcronymExpanderAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/acronymexpander";
        ...
        {
            { "acronym", new ValidationRule { Type = "string", Required = true, MaxLength = 20 } },
            { "context", new ValidationRule { Type = "string", Required = false } }
        };
        ...
        public AcronymExpanderAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public AcronymExpanderAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public AcronymExpanderAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, AcronymExpanderQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(AcronymExpanderQueryOptions options)
        {
        ...
        public ResponseObj Execute(AcronymExpanderQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(AcronymExpanderQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(AcronymExpanderQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(AcronymExpanderQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(AcronymExpanderQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(AcronymExpanderQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(AcronymExpanderQueryOptions options)
        {
