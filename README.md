...
[![RubyGems](https://img.shields.io/badge/RubyGems-E9573F?style=flat&logo=rubygems&logoColor=white)](https://rubygems.org/gems/apiverve_acronymexpander)
[![Packagist](https://img.shields.io/badge/Packagist-F28D1A?style=flat&logo=packagist&logoColor=white)](https://packagist.org/packages/apiverve/acronymexpander)
[![Go](https://img.shields.io/badge/Go-00ADD8?style=flat&logo=go&logoColor=white)](#-go)
[![Dart](https://img.shields.io/badge/Dart-0175C2?style=flat&logo=dart&logoColor=white)](https://pub.dev/packages/apiverve_acronymexpander)
...
```bash
curl -X GET "https://api.apiverve.com/v1/acronymexpander?acronym=API" \
...
[**View RubyGems Package →**](https://rubygems.org/gems/apiverve_acronymexpander) | [**Package Code →**](./ruby/)
...
[**View Packagist Package →**](https://packagist.org/packages/apiverve/acronymexpander) | [**Package Code →**](./php/)
...
[**View pub.dev Package →**](https://pub.dev/packages/apiverve_acronymexpander) | [**Package Code →**](./dart/)
...
A real response from the Acronym Expander API:
