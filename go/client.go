// Package acronymexpander provides a Go client for the Acronym Expander API.
//
// For more information, visit: https://apiverve.com/marketplace/acronymexpander?utm_source=go&utm_medium=readme
...
const (
	baseURL        = "https://api.apiverve.com/v1/acronymexpander"
	defaultTimeout = 30 * time.Second
)

// Client is the Acronym Expander API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Acronym Expander API client.
...
// Execute makes a request to the Acronym Expander API with typed parameters.
//
...
//   - acronym (required): string - The acronym to expand (max 20 characters) [maxLength: 20]
//   - context: string - Optional context to help determine the correct meaning
