...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/acronymexpander',
        'Source': 'https://github.com/apiverve/acronymexpander-api',
        'Bug Tracker': 'https://github.com/apiverve/acronymexpander-api/issues'
    },
    classifiers=[
