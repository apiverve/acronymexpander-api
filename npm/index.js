...
class acronymexpanderWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/acronymexpander');
        }
        ...
        this.validationRules = {"acronym":{"type":"string","required":true,"maxLength":20},"context":{"type":"string","required":false,"default":"General"}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/acronymexpander`);
        }
    }
