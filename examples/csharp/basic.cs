...
{
    class AcronymExpanderExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/acronymexpander";

        /// <summary>
        /// Make a GET request to the Acronym Expander API
        /// </summary>
        static async Task<JsonDocument> CallAcronymExpanderAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;acronym&quot;] &#x3D; &quot;API&quot;, [&quot;context&quot;] &#x3D; &quot;software&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Acronym Expander API...\n");

            var result = await CallAcronymExpanderAPI();
