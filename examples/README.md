# Acronym Expander API - Examples

This folder contains example code for using the Acronym Expander API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/acronymexpander',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/acronymexpander");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/acronymexpander](https://docs.apiverve.com/ref/acronymexpander)
